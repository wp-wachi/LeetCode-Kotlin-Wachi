...
//
// Related Topics Array Two Pointers Sorting 👍 16738 👎 2312


//leetcode submit region begin(Prohibit modification and deletion)
class Solution {
    fun merge(nums1: IntArray, m: Int, nums2: IntArray, n: Int): Unit {
        var lastRealIndex = m + n - 1
        var lastIndexNum2 = n - 1
        var lastIndexNum1 = m - 1
        while (lastRealIndex >= 0) {
            when {
                lastIndexNum2 == -1 -> {
                    nums1[lastRealIndex] = nums1[lastIndexNum1]
                    lastIndexNum1--
                }

                lastIndexNum1 == -1 -> {
                    nums1[lastRealIndex] = nums2[lastIndexNum2]
                    lastIndexNum2--
                }

                nums1[lastIndexNum1] > nums2[lastIndexNum2] -> {
                    nums1[lastRealIndex] = nums1[lastIndexNum1]
                    lastIndexNum1--
                }
